...
## Output
    russfellows@Russ-MacStudio polars-warp % uv run ./polars-parse-warp16.py ~/Public/warp-data/4kb/client-4[1-2]/intel-10RGW_100T_4kib_80R15W5D_vdb-master_trial_1.csv.zst
